	...
	<div id="editMemberModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
		  ...
		  <form method="post" id="updateMemberForm" class="form-horizontal" action="updateNotice.php">
          <div class="modal-body">
		  <div class="editMessage"></div>
            <div id="testmodal" style="padding: 5px 20px;">
				<div class="form-group">
					<label class="col-sm-4 control-label">Notice Description</label>
					<div class="col-sm-6">
...
/* 	alert(id); */
    if(id) {
        ...
        $.ajax({
            url: 'getSelectedNotice.php',
            type: 'post',
            data: {member_id : id},
            dataType: 'json',
            success:function(response) {
                $("#editDescription").val(response.notice);
