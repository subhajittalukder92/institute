...
function fetchRecords()
{
	include   'include/dbconfig.php';	
	$sql		="
				SELECT `note_info`.* ,payment.receipt_no,student_info.regno,payment.collect_by,payment.date,
				student_info.St_Name,student_info.Contact_no
				FROM note_info
				INNER JOIN payment
				ON note_info.recpt_no=payment.receipt_no
				INNER JOIN student_info
				ON student_info.Student_Id=note_info.student_id
