...
if(isset($_POST['submit']))
{
	...
	$to			= null;
	$particular = strtoupper(trim($_POST['particular']));
	$type		= "EXPENSE";
	...
	{
		$to			="CASH";
		$sql		= "INSERT INTO `daybook`(`user_id`, `date`, `particulars`, `cash`, `to`, `type`)
				   VALUES('$user','$date','$particular','$cashamount','$to','$type')";
	}
	else{
		$to			="BANK";
		$sql		= "INSERT INTO `daybook`(`user_id`, `date`, `particulars`,`bank`, `to`, `type`)
					   VALUES('$user','$date','$particular','$bankamount','$to','$type')";
	}
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-md-offset-3">
	          <h3 class="page-header">Expense Entry</h3>
				<form method="post" id="createTeacherForm" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="product" class="control-label">Particulars<span class="required"></span></label>
					...
					<div class="form-group">
						<label>Date</label>
						 <div class="input-group date form_date col-md-16" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input3" data-link-format="yyyy-mm-dd">
								<input class="form-control" type="text" name="date" id="date" value="" required autocomplete="off">
