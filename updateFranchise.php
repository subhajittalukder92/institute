...
if($_POST)
{
	...
	if(mysqli_num_rows($queryResult) > 0){
		...
		$franSql	= "UPDATE `franchises` SET `franchise_name`='$franchiseName', `director_name`='$director', `state_id`='$state',  `code`='$code', `district_id`='$district', `address`='$address', `contact`='$contact'  WHERE `id`='$memberId'";
